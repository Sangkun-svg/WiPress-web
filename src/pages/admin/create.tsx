...
const RequestPost = (props: any) => {
  ...
  const [type, setType] = useState('registerPost');
  ...
  const onSubmit: SubmitHandler<any> = async (formData) => {
    try {
      const newPost = await axios.post("/api/post/requestPost", { data: {...formData, user_id: props.user_id, post_type : type} });
  ...
  return (
    <Container>
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        >
            <MenuItem value={"registerPost"}>보도요청 자료</MenuItem>
            <MenuItem value={"article"}>기사</MenuItem>
            <MenuItem value={"notice"}>공지사항</MenuItem>
            <MenuItem value={"info"}>자료</MenuItem>
        </Select>
        </FormElement>
